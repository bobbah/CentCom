...
rmdir /Q /S CentCom.Exporter\bin
rmdir /Q /S CentCom.Exporter\obj
...
dotnet publish CentCom.Exporter -o publish/linux-x64/CentCom.Exporter -r "linux-x64" --self-contained false
...
dotnet publish CentCom.Exporter -o publish/win-x64/CentCom.Exporter -r "win-x64" --self-contained false
